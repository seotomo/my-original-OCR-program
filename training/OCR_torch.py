...
def plot_loss_accuracy_graph(train_acc_list,val_acc_list,train_loss_list,val_loss_list):
    plt.plot(train_acc_list, "-D", color="blue", label="train_loss", linewidth=2)
    plt.plot(val_acc_list, "-D", color="black", label="val_loss", linewidth=2)
    plt.plot(train_loss_list, "-D", color="green", label="train_accuracy", linewidth=2)
    plt.plot(val_loss_list, "-D", color="red", label="val_accuracy", linewidth=2)
